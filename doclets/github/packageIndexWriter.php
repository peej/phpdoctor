...
/** This class generates the overview-summary.md file that lists all parsed
 * packages.
 *
...
class PackageIndexWriter extends HTMLWriter {
    ...
    function packageIndexWriter(&$doclet) {
        ...
        foreach ($packages as $name => $package) {
            ...
            echo '<tr><td class="name"><a href="' . $package->asPath() . '/README.md">' . $package->name() . '</a></td>';
            echo '<td class="description">' . strip_tags($this->_processInlineTags($textTag, TRUE), '<a><b>**<u><em>') . '</td></tr>' . "\n";
        }
        echo '</table>' . "\n\n";
        ...
        $this->_write('overview-summary.md', 'Overview', TRUE);
    }
